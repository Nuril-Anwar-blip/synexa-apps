...
// ====================================================================
// File: emergency_call_screen_v2.dart
// Emergency Call Screen — Full theme/lang support + improved layout
// Letakkan di: lib/modules/emergency_call/emergency_call_screen.dart
// ====================================================================
...
class EmergencyCallScreenV2 extends StatefulWidget {
  const EmergencyCallScreenV2({super.key});

  @override
  State<EmergencyCallScreenV2> createState() => _EmergencyCallScreenV2State();
}

class _EmergencyCallScreenV2State extends State<EmergencyCallScreenV2>
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: RadialGradient(
                  ...
                  radius: 1.2,
                  colors: [
                    Colors.red.withOpacity(_isDark ? 0.3 : 0.15),
                    Colors.transparent,
                  ],
                ),
              ),
              ...
              child: Column(
                children: [
                  ...
                  if (!_isCalling) ...[
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'Lokasi Anda sedang dikirimkan ke RS terdekat',
                      style: TextStyle(
                        fontSize: 13 * _fs,
                        color: _isDark ? Colors.white54 : Colors.black45,
                      ),
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: _isDark ? Colors.white10 : Colors.white,
